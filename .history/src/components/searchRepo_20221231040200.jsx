          ...
          {currentUsers.map((user) => {
            ...
            return (
              <li key={user.id} className="searchRepo--list">
                  <h3 className="searchRepo--list__info"><strong className="str">Repo Title: </strong>{name}</h3>
                  <p className="searchRepo--list__info"><strong className="str">Repo About: </strong>{description}</p>
                  <a
                    href={html_url}
                    target="_blank"
                    rel="noreferrer"
