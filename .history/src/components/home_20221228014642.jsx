  ...
  return (
    <div className="home">
      ...
      <div className="home--container__top">
        <Link to="search" className="link">Click here to search for any Github user repository</Link>
      </div>
      ...
      <div className="home--container">
        <h1 className="home--heading">
          Github Portfolio repositories display app!!!
        </h1>
        <div className="home--paragraph">
          <h1 className="home--paragraph__heading">Hi, I'm {name}.</h1>
          <div className="home--paragraph__text">
            <p>
              This is a simple app that displays my github repositories. Click
              on the button below to view my repositories.
            </p>
          </div>
