      ...
      <div className="home--wrapper">
        ...
        <div className="home--info">
          <p className="home--item">
            <strong>Name: </strong> Michael Oluwaseun
          </p>
          <p className="home--item">
          ...
          <p className="home--item">
            <strong>Skills: </strong> Javascript, React, Node, Express, MongoDB,
            HTML, CSS, Bootstrap, Git, Github, Heroku, Netlify, Vercel, Firebase,
