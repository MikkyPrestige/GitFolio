...
const MoreInfo = () => {
  ...
  const { repo } = useParams(); // get repo data from the useParams hook in the contextProvider component
  const repoData = portfolio.find((item) => item.repo === repo); // find the repo data from the portfolio data
  // console.log(repo);
