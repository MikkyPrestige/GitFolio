  ...
  return (
    <section className="contact">
      ...
      <div className="app--details">
        <h2 className="details--heading">App Details</h2>
        <p>
          <strong>App Name: </strong>Github Repository display app
        </p>
        <p>
        ...
        <p>
          This is a simple app that displays
        ...
        <p>
          Data is passed between components with React useContext and React Router DOM is used for Routing in the app and React Helmet for SEO.
        </p>
        <p>
