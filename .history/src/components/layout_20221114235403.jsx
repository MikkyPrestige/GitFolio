  ...
  return (
    <div className="layout layoutTwo">
      <header className="layout--header">
        ...
        <nav className="layout--items">
          <CustomNavLink to="/" end className="layout--item layout--item__two">
            Home
          </CustomNavLink>
          <CustomNavLink to="repos" className="layout--item layout--item__two">
            Repositories
          </CustomNavLink>
          <CustomNavLink to="test" className="layout--item layout--item__two">
            Test Error
          </CustomNavLink>
          <CustomNavLink to="contact" className="layout--item layout--item__two">
            Contact
          </CustomNavLink>
        </nav>
      </header>
