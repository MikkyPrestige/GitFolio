    ...
    <div className="home">
      ...
      <div className="home--wrapper">
        ...
        <div className="home--paragraph">
          ...
          <p>
            It fetch's data from the Github API and React Router to displays the data 
            the data.
          </p>
          <p>It uses React Context to pass data between components.</p>
          <p>It uses React ErrorBoundary to display error message on the app UI when there is an error in the code.</p>
          <p> </p>
