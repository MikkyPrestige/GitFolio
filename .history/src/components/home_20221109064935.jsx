   ...
   <div className="home--wrapper">
        ...
        <div className="home--paragraph">
          ...
          <p className="home--paragraph__text">
            ...
            <p>
              This is a React app that uses Github API to fetch and display a list of my github portfolio repositories. It uses Github API to fetch the data and display it on a Page.
