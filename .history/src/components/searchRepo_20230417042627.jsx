            ...
            {currentUsers.map((user) => {
              ...
              return (
                <li key={user.id} className="searchRepo--list">
                  ...
                  {language && (
                    <p className="searchRepo--list__forks">{language}</p>
                  )}
                  {topics && (
                    <p className="searchRepo--list__forks">{topics}</p>
                  )}
                  {forks && (
                  <p className="searchRepo--list__forks">{forks}</p>
                  )}
                  {license && (
                  <p className="searchRepo--list__forks">{license}</p>
                  )}
                  {login && (
                  <p className="searchRepo--list__forks">{login}</p>
                  )}
                  <a
                    href={html_url}
                    target="_blank"
