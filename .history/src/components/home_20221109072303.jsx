  ...
  return (
   ...
   <div className="home--wrapper">
      ...
      <div className="home--container__bottom">
          <h2 className="home--container__heading"><strong>Name: </strong>
            {display?.name}
          </h2>
          <h3 className="home--container__text"><strong>Bio: </strong>
            {display?.bio}
          </h3>
            <h3 className="home--container__heading"><strong>Followers: </strong>
              {display?.followers}
            </h3>
            <h3 className="home--container__heading"><strong>Following: </strong>
              {display?.following}
            </h3>
            <h3 className="home--container__heading"><strong>Location: </strong>
              {display?.location}
            </h3>
            <h3 className="home--container__heading"><strong>Joined: </strong>
              {display?.created_at}
            </h3>
        </div>
