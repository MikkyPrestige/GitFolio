        ...
        <div className="searchRepo--results">
          <ul className="searchRepo--lists">
            ...
            {currentUsers.map((user, index) => {
              const { name, html_url, description, forks_count, login, language, topics } = user || [];
              return (
                ...
                <li key={index} className="searchRepo--list">
                  ...
                  {forks_count && (
                  <p className="searchRepo--list__content"><strong>Repository Forks </strong>{forks_count}</p>
                  )}
                  {login && (
