...
// localStorage.setItem("repos", JSON.stringify(portfolio))
  ...
  const { name, description, html_url, homepage, language, created_at, updated_at, pushed_at, full_name, topics, size, open_issues, visibility, login, default_branch } = repoData || {};
