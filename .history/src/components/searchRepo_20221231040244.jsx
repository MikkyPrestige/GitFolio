  ...
  return (
    <div className="searchRepo">
      <h1 className="searchRepo--heading">
        Explore other Github users repository
      </h1>
          ...
          {currentUsers.map((user) => {
            ...
            return (
              <li key={user.id} className="searchRepo--list">
                  <h3 className="searchRepo--list__title"><strong className="str">Repo Title: </strong>{name}</h3>
                  <p className="searchRepo--list__desc"><strong className="str">Repo About: </strong>{description}</p>
                  <a
                    href={html_url}
                    target="_blank"
                    rel="noreferrer"
